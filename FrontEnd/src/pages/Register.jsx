      ...
      <div className="w-full max-w-5xl flex flex-col lg:flex-row items-center justify-between gap-12 z-10 relative">
        ...
        <div className="flex-1 text-left space-y-6 max-w-lg lg:pr-6">
          ...
          <h1 className="layout-hero text-white tracking-tight">
            Initiate your financial intelligence workspace.
          </h1>
          
          <p className="text-zinc-500 text-xs font-semibold leading-relaxed max-w-sm">
            Trace subscription telemetry, enforce boundaries, and unlock optimization suggestions immediately.
          </p>
        ...
        <div className="w-full max-w-[360px] shrink-0">
          ...
          >
            <div className="mb-6">
              ...
              <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wide">Enter authentication coordinates</span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-1">
                  <label htmlFor="reg-name" className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest block px-0.5">Full Name</label>
                  <input
                    id="reg-name"
                    type="text"
                    required
                ...
                {/* Email address */}
                <div className="space-y-1">
                  <label htmlFor="reg-email" className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest block px-0.5">Email Address</label>
                  <input
                    id="reg-email"
                    type="email"
                    required
                ...
                {/* Password */}
                <div className="space-y-1">
                  <label htmlFor="reg-password" className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest block px-0.5">Password</label>
                  <input
                    id="reg-password"
                    type="password"
                    required
